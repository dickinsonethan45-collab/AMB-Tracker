...
BOT_TOKEN: str      = os.environ.get("BOT_TOKEN") or cfg.get("BotToken", "")
...
if not BOT_TOKEN:
    raise RuntimeError(
        "BOT_TOKEN is not set. On Railway, add it under Variables. "
        "Locally, put it in config.json under 'BotToken'."
    )
